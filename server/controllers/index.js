...
module.exports.displayHomePage = (req, res, next) => {
    res.render('content/home', {title: 'Home', displayName: req.user ? req.user.displayName : ''});
}
...
module.exports.displayContactPage = (req, res, next) => {
    res.render('content/contant', { title: 'Contact', displayName: req.user ? req.user.displayName : ''});
}
